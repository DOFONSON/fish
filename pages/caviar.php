<?php
$title = 'ОСЕТРИНСКОЕ РЫБХОЗЯЙСТВО - Икра пищевая';
$extraStyles = ['../css/caviar.css'];
$activePage = 'aliveordead';
$metaDescription = 'Пищевая икра осетровых: прижизненный и классический метод, сертификация.';
$metaKeywords = ['икра осетровая', 'пищевая икра', 'золотая икра', 'честный знак', 'меркурий'];
...
?>
    ...
    <main class="caviar">
        ...
        <section>
            <div class="content">
                <h1 class="title">Икра пищевая</h1>
                <div class="text">
                    <p>
